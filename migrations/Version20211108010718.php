 ...
 */
final class Version20211108010718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address ADD user_id INT DEFAULT NULL, ADD name VARCHAR(255) NOT NULL, ADD company VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address DROP user_id, DROP name, DROP company');
